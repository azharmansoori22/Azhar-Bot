...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://paktelebeam:5G9BO28O7detTBfS@cluster0.livaius.mongodb.net//?retryWrites=true&w=majority" ;
...
global.gurl = 'https://youtube.com/c/azharmansoori22' ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '923184474176'; ;
global.devs = "923184474176"; //Dont change it From here
global.github  = process.env.YOUR_GITHUB || 'https://github.com/azharmansoori22/Azhar-Bot';
global.scan  = process.env.QR_URL || 'https://replit.com/@azharmansoori22/Suhail-Md?v=1';
global.website = 'https://github.com/azharmansoori22/Azhar-Bot' ; //wa.me/+923000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/NpA3ZsJ.jpeg' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "ThickensOptimum",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'ΛZΉΛЯ-BӨƬ',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `Azhar`,
  ...
  caption :process.env.CAPTION || "```ᴘᴏᴡᴇʀᴇᴅ ʙʏ Azhar```",   //*『ΛZΉΛЯ-BӨƬ』*\n t.me/azharmansoori22"),
